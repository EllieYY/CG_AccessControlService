 ...
 **/
@Data
public class StrikeStateEvent extends OperationResult implements DeviceEvent {
    ...
    public void sendMq(QueueProducer queueProducer, String sn) {
        MqMessage message = new MqMessage(Constants.EVENT_STRIKE, sn, doorNo, time, state, "");
