...
import com.wimetro.acs.util.ProtocolFiledUtil.CmdPropParam;
...
public abstract class Message<T extends MessageBody> {
    ...
    public void encode(ByteBuf byteBuf) {
        // 报文体编码
        String bodyHexStr = encodeMsgBody();
        // 计算报文体长度
...
//        log.info("转码前 {}", hexCmd);
    ...
    public List<CmdPropParam> getSortedParams(Class cls) {
...
//                    log.info("[field] {} - {}", field.getName(), hexStr);
     ...
     * @return
     */
    private Object codec(Field field, Object src, String codecMethod, boolean hexFlag, int sort, int len) {
        Object val;
